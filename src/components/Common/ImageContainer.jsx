    ...
    <>
      <div className="relative flex items-center justify-center group mb-10 ">
        ...
        <div className="absolute flex w-full justify-between top-1/2 transform -translate-y-1/2">
          <FaAngleLeft
            className="h-6 w-6 text-white bg-black bg-opacity-50 p-2 rounded-r-full cursor-pointer opacity-0 group-hover:opacity-100"
            onClick={prevImage}
          />
          <FaAngleRight
            className="h-6 w-6 text-white bg-black bg-opacity-50 p-2 rounded-l-full cursor-pointer opacity-0 group-hover:opacity-100 "
            onClick={nextImage}
          />
        </div>
      </div>
